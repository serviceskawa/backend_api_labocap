...
public interface DiscussionMessageRepository extends JpaRepository<DiscussionMessage, UUID> {
     ...
     *
     * <p>Ses propres messages sont écartés : on ne se notifie pas soi-même, et
     * un badge qui s'allume en écrivant ferait douter de tous les autres.</p>
     *
     * <p>Ne compte que les fils où elle participe. Un médecin tagué sur un cas
     * qui n'est pas le sien y a été ajouté comme participant à ce moment-là :
     * la règle d'adressage de la maquette se traduit ainsi, une seule fois, au
     * lieu d'être rejouée à chaque lecture.</p>
     *
